...
fetch('https://data.vigan.gov.ph/api/3/action/package_search?q=tourism&rows=5')
  ...
  return (
    <div className="bg-white min-h-screen pb-20">
      ...
      {/* Header */}
      <div className="bg-black text-white border-b-4 border-vigan-secondary pt-16 pb-20 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 relative z-10">
          <div className="flex items-center gap-3 mb-6 text-vigan-secondary">
            <Terminal size={24} />
            <span className="font-mono font-bold tracking-widest text-sm">DEVELOPER HUB</span>
          </div>
          <h1 className="font-display text-4xl md:text-5xl font-bold mb-6">REST API Documentation</h1>
          <p className="text-white/70 text-lg leading-relaxed font-mono text-sm max-w-2xl">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <div className="prose prose-vigan max-w-none">
          ...
          <h3 className="mt-10 border-b border-vigan-gray-200 pb-2">1. Searching for Datasets</h3>
          <p>Use the <code>package_search</code> endpoint to find datasets matching a query or filter.</p>
          
          <div className="bg-vigan-gray-50 rounded-lg border border-vigan-border p-4 my-4 font-mono text-sm overflow-x-auto">
            <span className="text-vigan-muted"># GET /api/3/action/package_search</span><br/>
            <span className="text-vigan-primary">curl</span> "https://data.vigan.gov.ph/api/3/action/package_search?q=budget&rows=10"
          </div>

          <h3 className="mt-10 border-b border-vigan-gray-200 pb-2">2. Fetching Dataset Details</h3>
          ...
          <div className="bg-vigan-gray-50 rounded-lg border border-vigan-border p-4 my-4 font-mono text-sm overflow-x-auto">
            <span className="text-vigan-muted"># GET /api/3/action/package_show</span><br/>
            <span className="text-vigan-primary">curl</span> "https://data.vigan.gov.ph/api/3/action/package_show?id=annual-budget-2026"
          </div>

          <h3 className="mt-10 border-b border-vigan-gray-200 pb-2">3. Example Integration (JavaScript)</h3>
          ...
          <div className="bg-vigan-light/30 border-l-4 border-vigan-secondary p-5 mt-10 rounded-r-lg">
            <h4 className="flex items-center gap-2 font-bold text-vigan-text mb-2 m-0">
              <BookOpen size={18} className="text-vigan-secondary" /> 
              Full CKAN API Reference
            </h4>
            <p className="text-sm m-0 text-vigan-text/80">
